...
if [[ "$IP" == 206 || "$IP" == 207 ]]; then
  devices='MYRIAD'
  face_detection="./model_library/intel/face-detection-0100/FP16/face-detection-0100.xml"
  landmarks_detection="./model_library/intel/landmarks-regression-retail-0009/FP16/landmarks-regression-retail-0009.xml"
  reidentification_model="./model_library/intel/face-reidentification-retail-0095/FP16/face-reidentification-retail-0095.xml"
fi
